...
<body>
  ...
  <a href="<?php echo base_url("excel/template.xlsx"); ?>">Download Format</a>
  <br>
  <br>
  
  <!-- Buat sebuah tag form dan arahkan action nya ke controller ini lagi -->
  <form method="post"  id="form_ticketing">
    <!-- 
  ...
  <script type="text/javascript">
     $('form#form_ticketing').on('submit', function(e) {
          ...
          alert(1); 
          $.ajax({
              url : "<?php echo base_url("akuntansi/akuntansi/laporan_keuangan/neraca_saldo/form"); ?>",
              type: "POST",
