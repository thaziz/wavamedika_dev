          ...
          <div class="col-md-12">
            <div class="box box-primary">
              <div id="width-sensor" class="box-body" style="height: 500px">
                ...
                <hr>
                <!-- <table id="dg" title="Daftar Neraca" style=";width:100%;height:auto"
...
$('body').on('click', '.btn-cetak', function () {
    ...
    $.ajax({
        url: '<?= site_url() ?>akuntansi/akuntansi/laporan_keuangan/neraca/cetak',
        type: "post",
        data: {'id_permohonan': $(this).attr("data-id"), 'id_instalasi': $(this).attr("data-instalasi")},
        dataType: "json",
        success: function (data) {
            if (data.success === true) {
                $("#frame_file_surat_detail").attr("src", "<?= base_url() ?>assets/file/cetak_neraca.pdf")
