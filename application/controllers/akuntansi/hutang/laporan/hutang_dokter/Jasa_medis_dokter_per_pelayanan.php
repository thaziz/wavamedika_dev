...
class Jasa_medis_dokter_per_pelayanan extends CI_Controller {
    ...
    public function index()
    {
    	...
    	$this->load->view('akuntansi/hutang/laporan/hutang_dokter/v_jasa_medis_dokter_per_pelayanan', $this->data_respon);
    }
}
