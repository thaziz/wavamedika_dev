...
class Laporan_penerimaan_piutang_pasien_umum extends CI_Controller {
    ...
    public function index()
    {
    	...
    	$this->load->view('akuntansi/piutang/laporan/v_laporan_penerimaan_piutang_pasien_umum', $this->data_respon);
    }
}
