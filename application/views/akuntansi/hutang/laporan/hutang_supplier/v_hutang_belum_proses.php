...
<?php $this->load->view("includes/sidebar.php", $sidebar) ?>
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>Laporan Hutang Belum Proses</h1>
    </section>
          ...
          <div class="col-md-12">
            <div class="box box-primary">
              <div id="width-sensor" class="box-body" style="height: 500px">
                ...
                <div style = "margin-bottom:5px">
                  <select id="nama_supplier" class="easyui-combobox" name="nama_supplier" style="width:40.2%;" label="Nama Supplier:" labelwidth="100px">
                      <option value=""></option>
                      <option></option>
                  </select>
                </div>
                ...
                <hr>
                <!-- <table id="dg" title="Daftar Hutang Belum Proses" style=";width:100%;height:auto"
...
$('body').on('click', '.btn-cetak', function () {
    ...
    if(jenis_laporan=="summary") {
      ...
      file_cetak = 'cetak_hutang_belum_proses_summary.pdf';
    }
    else if(jenis_laporan=="detail") {
      function_cetak = 'cetak_detail';
      file_cetak = 'cetak_hutang_belum_proses_detail.pdf';
    }
    // console.log(function_cetak, file_cetak);

    $.ajax({
        url: '<?= site_url() ?>akuntansi/hutang/laporan/hutang_supplier/hutang_belum_proses/'+function_cetak,
        type: "post",
