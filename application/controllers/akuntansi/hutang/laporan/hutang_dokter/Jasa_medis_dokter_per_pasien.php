...
class Jasa_medis_dokter_per_pasien extends CI_Controller {
    ...
    public function index()
    {
    	...
    	$this->load->view('akuntansi/hutang/laporan/hutang_dokter/v_jasa_medis_dokter_per_pasien', $this->data_respon);
    }
}
