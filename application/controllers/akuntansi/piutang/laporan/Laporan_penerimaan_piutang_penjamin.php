...
class Laporan_penerimaan_piutang_penjamin extends CI_Controller {
    ...
    public function index()
    {
    	...
    	$this->load->view('akuntansi/piutang/laporan/v_laporan_penerimaan_piutang_penjamin', $this->data_respon);
    }
}
