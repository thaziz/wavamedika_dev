...
class Penerimaan_piutang_pasien_karyawan extends CI_Controller {
    ...
    public function index()
    {
    	...
    	$this->load->view('akuntansi/transaksi/v_penerimaan_piutang_pasien_karyawan', $this->data_respon);
    }
}
