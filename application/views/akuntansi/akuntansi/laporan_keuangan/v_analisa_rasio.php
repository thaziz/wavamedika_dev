            ...
            <div class="box box-primary">
              <div id="width-sensor" class="box-body" style="height: 500px">
                <div style = "margin-bottom:10px">
                  <select id="combo-kriteria" class="easyui-combobox" name="dept" style="width:20%;" label="Periode Bulan" labelwidth="100px">
                  ...
                  <select id="combo-kriteria" class="easyui-combobox" name="dept" style="width:20%;" label="Tahun" labelAlign="center">
                    <?php $th = date("Y");
                    for($th;$th>=(date("Y")-4);$th--) { ?>
                ...
                <hr>
                <!-- <table id="dg" title="Daftar Analisa Rasio" style=";width:100%;height:auto"
...
$(function(){
    ...
    $.ajax({
        url: '<?= site_url() ?>akuntansi/akuntansi/laporan_keuangan/analisa_rasio/cetak',
        type: "post",
        data: {'id_permohonan': $(this).attr("data-id"), 'id_instalasi': $(this).attr("data-instalasi")},
        dataType: "json",
        success: function (data) {
            if (data.success === true) {
                $("#frame_file_surat_detail").attr("src", "<?= base_url() ?>assets/file/cetak_analisa_rasio.pdf")
