...
<!--                 <div style = "margin-bottom:10px;border-style: solid">
                ...
                <table id="dg" title="Daftar Hutang Pembelian" style=";width:99%;height:700px; margin-top:1%;"
  ...
  <div id="w" class="easyui-window" title="Input Hutang Pembelian" data-options="iconCls:''" style="width:1120px;height:570px;padding:10px;">
    <form id="tbl2" >
...
<div id="wnopo" class="easyui-window" title="Search PO" data-options="iconCls:'icon-'" style="width:900px;height:550px;padding:10px;">
  ...
  <!-- <div id="um" class="easyui-window" title="Input Hutang Pembelian" data-options="iconCls:'icon-save'" style="width:1400px;height:850px;padding:10px;"> -->
   <!-- <table id="umk" title="Daftar Hutang Pembelian" style=";width:100%;height:auto"
          pagination="true" idField="ids"
          rownumbers="true" fitColumns="true" singleSelect="true">
        <thead>
          <tr>
            <th field="no_jurnals" width="50" editor="{type:'validatebox',options:{required:true}}">No Jurnal</th>
            <th field="tanggals" width="50" editor="{type:'validatebox',options:{required:true}}">Tanggal</th>
            <th field="keterangans" width="50" editor="text">Keterangan</th>
            <th field="statuss" width="50" editor="text">Status</th>
            <th field="user_entrys" width="50" editor="text">User Entry</th>
            <th field="tgl_entrys" width="50" editor="text">Tgl Entry</th>
            <th field="user_updates" width="50" editor="text">User Update</th>
            <th field="tgl_updates" width="50" editor="text">Tanggal Update</th>
          </tr>
        </thead>
      </table> -->
    <!-- </div> -->
