          ...
          <div class="col-md-12">
            <div class="box box-primary">
              <div id="width-sensor" class="box-body">
                  <table id="dg" title="Daftar User" style=";width:100%;height:auto"
...
$(function(){
    $('#dg').edatagrid({
        ...
        saveUrl: '<?php echo base_url('sistem/manajemen_user/tambah_user') ?>',
        updateUrl: '<?php echo base_url('sistem/manajemen_user/ubah_user') ?>',
        destroyUrl: '<?php echo base_url('sistem/manajemen_user/hapus_user') ?>'
    });
});
</script>
</body>
